...
$(document).ready(function () {
	...
	var swiper = new Swiper(".us__container-cont-swiper", {
		spaceBetween: 20,
        autoplay: {
          delay: 2500,
	...
	var swiper = new Swiper(".can__container-swiper", {
		spaceBetween: 20,
        navigation: {
          nextEl: ".swiper-button-next1",
          prevEl: ".swiper-button-prev1",
	...
	$('.vor__container-right-items-item').hover(function() {
		$('.vor__container-sh-item').addClass('grey')
		var numm = $(this).attr('data-numm')
		$('#' + numm).removeClass('grey')
	}, function() {
		$('.vor__container-sh-item').removeClass('grey')
	})

	$('.cta-left-form').each(function() {
        var it = $(this);
         it.validate({
			rules: {
				phone: {
	 ...
	 $('.six__container-item').hover(function() {
		$('.six__container-item').addClass('grey')
		$(this).removeClass('grey')
		$(this).addClass('act')
	}, function() {
		$('.six__container-item').removeClass('grey')
		$('.six__container-item').removeClass('act')
	})

	$('.pcttr').hover(function() {
		$('.pcttr').addClass('grey')
		$(this).removeClass('grey')
	}, function() {
		$('.pcttr').removeClass('grey')
	})

	$('.popup-zak-form').each(function() {
        var it = $(this);
         it.validate({
			rules: {
				phone: {
	 ...
	 $('.hm11').click(function() {
		 $('.header__container-menu-cont').toggleClass('act')
	 })
	 $(window).scroll(function() {
		$('.header__container-menu-cont').removeClass('act')
	})
	$('.hm22').click(function() {
		$('.header-popup').addClass('act')
    	$('html').addClass('no-scroll');
	})
	$('.header-popup-menu-close').click(function() {
		$('.header-popup').removeClass('act')
    	$('html').removeClass('no-scroll');
	})
	$('.header-popup-menu-item').click(function() {
		$('.header-popup').removeClass('act')
    	$('html').removeClass('no-scroll');
	})
	$('.header-popup-blur').click(function() {
		$('.header-popup').removeClass('act')
    	$('html').removeClass('no-scroll');
	})
	$('.hmcc').click(function() {
